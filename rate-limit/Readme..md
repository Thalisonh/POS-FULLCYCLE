...
* O sistema deve responder adequadamente quando o limite é excedido:
    1. Código HTTP: 429
    2. Mensagem: you have reached the maximum number of requests or actions allowed within a certain time frame
...
go test internal/middleware/middleware_test.go